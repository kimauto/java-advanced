...
public class User_Management_Service {
    ...
    private void insertMember() {
        ...
        try {
            ...
            String sql = " " +
                    "INSERT INTO members (memid, memname, mempass, memtel, memaddr) " +
                    "VALUES (?,?,?,?,?); ";
    ...
    private void updateMember() {
        ...
        try {
            ...
            String query = new StringBuilder()
                    .append(" UDATE members SET ")
                    .append(" memName = ?, memPass = ?, memTel = ?, memAddr = ?")
                    .append(" where memID = ?").toString();
    ...
    private void updateMember2() {
        ...
        try {
            conn = DBUtil.getConnection();
            // 동적으로 컬럼명을 설정하여 업데이트 쿼리 작성
            String query = "UPDATE members SET " + updateField + " = ? WHERE memId = ?";
    ...
    private void displayMember() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                member.setMemAddr(rs.getString("memAddr"));
    ...
    private int getMemberCount(String memId) {
        ...
        try {
            ...
            String query = " select count(*) from members where memID = ? ";
            pstmt = conn.prepareStatement(query);
            pstmt.setString(1, memId);
