...
public class StudentMain {
    public static void main(String[] args) {
        ...
        Student 김병곤 = new Student("김병규", 20251111, new Subject(70, 80, 90));
        Student 최문규 = new Student("최문규", 20251212, new Subject(90, 100, 80));
        Student 김덕규 = new Student("김덕규", 20251313, new Subject(70, 90, 70));
        Student 조덕규 = new Student("조덕규", 20251414, new Subject(70, 90, 70));
        ...
        for (Student student : students) {
            ...
            System.out.printf(" 총점 : %d 평균 : %.2f\n", student.getSubject().total(), student.getSubject().average());
